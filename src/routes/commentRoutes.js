import { getCommentLikes, getComments, getCommentLikeStatus, handleLikeComment, createFeedComment } from "../controllers/commentController.js";
...
router.get("/comments/feed/:feedId/like/:commentId", authToken, getCommentLikeStatus);
